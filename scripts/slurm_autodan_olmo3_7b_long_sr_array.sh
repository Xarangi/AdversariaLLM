#!/bin/bash
#SBATCH --job-name=autodan-olmo3-7b-sr
...
#SBATCH --array=0-299
#SBATCH --output=/home/mila/s/sarangis/AdversariaLLM/slurm-autodan-olmo3-7b-sr-%A_%a.out
#SBATCH --error=/home/mila/s/sarangis/AdversariaLLM/slurm-autodan-olmo3-7b-sr-%A_%a.err
