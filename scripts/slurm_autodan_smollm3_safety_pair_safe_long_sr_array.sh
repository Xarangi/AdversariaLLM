#!/bin/bash
#SBATCH --job-name=autodan-smollm3-safety-pair-safe
#SBATCH --partition=long
#SBATCH --gres=gpu:l40s:1
#SBATCH --exclude=cn-a[001-011],cn-c[002-014,016-019,021-034,036-040]
#SBATCH --cpus-per-task=2
#SBATCH --mem=32G
#SBATCH --time=7-00:00:00
#SBATCH --array=0-99
#SBATCH --output=/home/mila/s/sarangis/AdversariaLLM/slurm-autodan-smollm3-safety-pair-safe-%A_%a.out
#SBATCH --error=/home/mila/s/sarangis/AdversariaLLM/slurm-autodan-smollm3-safety-pair-safe-%A_%a.err
...
MONGO_PORT=$((29017 + SLURM_ARRAY_TASK_ID))
