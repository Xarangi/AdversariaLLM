#!/bin/bash
#SBATCH --job-name=crescendo-olmo3-7b-sr
...
#SBATCH --array=0-99
#SBATCH --output=/home/mila/s/sarangis/AdversariaLLM/slurm-crescendo-olmo3-7b-sr-%A_%a.out
#SBATCH --error=/home/mila/s/sarangis/AdversariaLLM/slurm-crescendo-olmo3-7b-sr-%A_%a.err
...
MONGO_PORT=$((34017 + SLURM_ARRAY_TASK_ID))
