#!/bin/bash
#SBATCH --job-name=crescendo-smollm3-safety-pair-safe
...
#SBATCH --array=0-99
#SBATCH --output=/home/mila/s/sarangis/AdversariaLLM/slurm-crescendo-smollm3-safety-pair-safe-%A_%a.out
#SBATCH --error=/home/mila/s/sarangis/AdversariaLLM/slurm-crescendo-smollm3-safety-pair-safe-%A_%a.err
...
MONGO_PORT=$((37017 + SLURM_ARRAY_TASK_ID))
