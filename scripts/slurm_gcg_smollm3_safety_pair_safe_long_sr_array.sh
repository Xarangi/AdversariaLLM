#!/bin/bash
#SBATCH --job-name=gcg-smollm3-safety-pair-safe
...
#SBATCH --array=0-99
#SBATCH --output=/home/mila/s/sarangis/AdversariaLLM/slurm-gcg-smollm3-safety-pair-safe-%A_%a.out
#SBATCH --error=/home/mila/s/sarangis/AdversariaLLM/slurm-gcg-smollm3-safety-pair-safe-%A_%a.err
