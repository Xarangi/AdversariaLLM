#!/bin/bash
#SBATCH --job-name=gcg-smollm3-safety-pair-unsafe
...
#SBATCH --array=0-99
#SBATCH --output=/home/mila/s/sarangis/AdversariaLLM/slurm-gcg-smollm3-safety-pair-unsafe-%A_%a.out
#SBATCH --error=/home/mila/s/sarangis/AdversariaLLM/slurm-gcg-smollm3-safety-pair-unsafe-%A_%a.err
...
MONGO_PORT=$((28017 + SLURM_ARRAY_TASK_ID))
